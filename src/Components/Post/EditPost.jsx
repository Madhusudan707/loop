...
import { deletePostAsync, savePostAsync } from "../../features/postSlice.js";
    ...
    <div className="fixed h-screen w-screen bg-gray-200 bg-opacity-95 flex justify-center md:px-80">
      <div className="relative w-full h-3/4 p-4 pt-8 mt-8 md:px-52">
        <div
          ...
          className=" absolute top-0 right-4 text-3xl  rounded-full h-10 w-10 flex items-center justify-center p-2 text-blue-400 md:right-40 cursor-pointer"
        >
        ...
        <div className="flex justify-end pt-2 mt-3">
          <div className="flex fixed justify-between w-44">
            <button onClick={saveOnClick} disabled={!disableBtn}>Save</button>
